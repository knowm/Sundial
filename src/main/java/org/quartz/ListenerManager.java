 ...
 * provides notifications of <code>Trigger</code> firings. The <code>{@link SchedulerListener}</code> interface provides notifications of <code>Scheduler</code> events and errors. Listeners can be associated with local schedulers through the
...
public interface ListenerManager {
  ...
  /**
   * Add the given <code>{@link JobListener}</code> to the <code>Scheduler</code>, and register it to receive events for Jobs that are matched by ANY of the given Matchers. If no matchers are provided, the <code>EverythingMatcher</code> will be used.
   * 
   * @see Matcher
  ...
  /**
   * Add the given <code>{@link TriggerListener}</code> to the <code>Scheduler</code>, and register it to receive events for Triggers that are matched by ANY of the given Matchers. If no matcher is provided, the <code>EverythingMatcher</code> will be
   * used.
   * 
   * @see Matcher
   * @see EverythingMatcher
