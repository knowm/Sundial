...
public interface CalendarIntervalTrigger extends Trigger {
  ...
  /**
   * <p>
   * Instructs the <code>{@link Scheduler}</code> that upon a mis-fire situation, the <code>{@link CalendarIntervalTrigger}</code> wants to be fired now by <code>Scheduler</code>.
   * </p>
   */
  public static final int MISFIRE_INSTRUCTION_FIRE_ONCE_NOW = 1;
  /**
   * <p>
   * Instructs the <code>{@link Scheduler}</code> that upon a mis-fire situation, the <code>{@link CalendarIntervalTrigger}</code> wants to have it's next-fire-time updated to the next time in the
   * schedule after the current time (taking into account any associated <code>{@link Calendar}</code>, but it does not want to be fired now.
   * </p>
   */
  ...
  /**
   * <p>
   * Get the the time interval that will be added to the <code>DateIntervalTrigger</code>'s fire time (in the set repeat interval unit) in order to calculate the time of the next trigger repeat.
   * </p>
   */
