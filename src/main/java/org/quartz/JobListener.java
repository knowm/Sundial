...
/**
 * The interface to be implemented by classes that want to be informed when a <code>{@link org.quartz.JobDetail}</code> executes. In general,
...
public interface JobListener {
  ...
  /**
   * <p>
   * Called by the <code>{@link Scheduler}</code> when a <code>{@link org.quartz.JobDetail}</code> is about to be executed (an associated
  ...
  /**
   * <p>
   * Called by the <code>{@link Scheduler}</code> when a <code>{@link org.quartz.JobDetail}</code> was about to be executed (an associated
  ...
  /**
   * <p>
   * Called by the <code>{@link Scheduler}</code> after a <code>{@link org.quartz.JobDetail}</code> has been executed, and be for the associated
