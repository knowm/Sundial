...
public class CalendarIntervalTriggerImpl extends AbstractTrigger implements CalendarIntervalTrigger {
  ...
  /**
   * <p>
   * set the the time interval that will be added to the <code>DateIntervalTrigger</code>'s fire time (in the set repeat interval unit) in order to calculate the time of the next trigger repeat.
   * </p>
   * 
  ...
  /**
   * <p>
   * Updates the <code>DateIntervalTrigger</code>'s state based on the MISFIRE_INSTRUCTION_XXX that was selected when the <code>DateIntervalTrigger</code> was created.
   * </p>
   * <p>
  ...
  /**
   * <p>
   * Returns the previous time at which the <code>DateIntervalTrigger</code> fired. If the trigger has not yet fired, <code>null</code> will be returned.
   */
  @Override
