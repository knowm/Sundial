...
/**
 * The interface to be implemented by classes that want to be informed when a <code>{@link Trigger}</code> fires. In general, applications that use a <code>Scheduler</code> will not have use for this mechanism.
 * 
...
public interface TriggerListener {
  ...
  /**
   * <p>
   * Called by the <code>{@link Scheduler}</code> when a <code>{@link Trigger}</code> has fired, and it's associated <code>{@link org.quartz.JobDetail}</code> is about to be executed.
   * </p>
   * <p>
  ...
  /**
   * <p>
   * Called by the <code>{@link Scheduler}</code> when a <code>{@link Trigger}</code> has fired, and it's associated <code>{@link org.quartz.JobDetail}</code> is about to be executed. If the implementation vetos the execution (via returning
  ...
  /**
   * <p>
   * Called by the <code>{@link Scheduler}</code> when a <code>{@link Trigger}</code> has fired, it's associated <code>{@link org.quartz.JobDetail}</code> has been executed, and it's <code>triggered(xx)</code> method has been called.
   * </p>
   * 
