...
/**
 * The interface to be implemented by classes that want to provide a <code>
 * {@link org.quartz.jobs.Job}</code> and <code>{@link org.quartz.triggers.Trigger}</code> storage
 * mechanism for the <code>{@link org.quartz.QuartzScheduler}</code>'s use.
 *
...
public interface JobStore {
  ...
  /**
   * Remove (delete) the <code>{@link org.quartz.jobs.Job}</code> with the given key, and any <code>
   * {@link org.quartz.triggers.Trigger}</code> s that reference it.
   *
   ...
   *
   * @return <code>true</code> if a <code>Trigger</code> with the given name was found and removed
   *     from the store.
   */
  boolean removeTrigger(String triggerKey) throws JobPersistenceException;

  /**
   * Remove (delete) the <code>{@link org.quartz.triggers.Trigger}</code> with the given key, and
   ...
   *     from the store.
   */
  boolean replaceTrigger(String triggerKey, OperableTrigger newTrigger)
   ...
   * exception, or was vetoed), and that the <code>{@link org.quartz.jobs.JobDataMap}</code> in the
