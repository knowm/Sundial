 ...
 * </p>
 * <p>
 * <code>JobDataMap</code> instances can also be stored with a <code>Trigger</code>. This can be useful in the case where you have a Job that is stored in the scheduler for regular/repeated use by multiple Triggers, yet with each independent
 * triggering, you want to supply the Job with different data inputs.
 * </p>
 * <p>
 * The <code>JobExecutionContext</code> passed to a Job at execution time also contains a convenience <code>JobDataMap</code> that is the result of merging the contents of the trigger's JobDataMap (if any) over the Job's JobDataMap (if any).
 * </p>
 * 
 * @see Job
 * @see StatefulJob
...
public class JobDataMap extends StringKeyDirtyFlagMap implements Serializable {
  ...
  /**
   * <p>
   * Adds the given <code>boolean</code> value as a string version to the <code>Job</code>'s data map.
   * </p>
   */
  ...
  /**
   * <p>
   * Adds the given <code>Character</code> value as a string version to the <code>Job</code>'s data map.
   * </p>
   */
  ...
  /**
   * <p>
   * Adds the given <code>double</code> value as a string version to the <code>Job</code>'s data map.
   * </p>
   */
  ...
  /**
   * <p>
   * Adds the given <code>Integer</code> value as a string version to the <code>Job</code>'s data map.
   * </p>
   */
