...
public interface Trigger extends Serializable, Cloneable, Comparable<Trigger> {
   ...
   * {@link Trigger}</code> wants the <code>{@link org.quartz.jobs.JobDetail}</code> to re-execute
   ...
   * all <code>Trigger</code>s referencing the same <code>{@link org.quartz.jobs.JobDetail}</code>
   * as this one should be put in the <code>COMPLETE</code> state.
   *
   * <p><code>SET_TRIGGER_ERROR</code> Instructs the <code>{@link Scheduler}</code> that all <code>
   * Trigger</code>s referencing the same <code>{@link org.quartz.jobs.JobDetail}</code> as this one
   ...
   * for the <code>getSmartMisfirePolicy()</code> method on the particular <code>Trigger</code>
   ...
   * <code>Trigger</code> from the <code>{@link org.quartz.core.JobStore}</code>.
   */
