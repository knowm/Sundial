 ...
 * <p>
 * A <code>Scheduler</code> maintains a registry of <code>{@link org.quartz.JobDetail}</code>s and <code>{@link Trigger}</code>s. Once registered, the
 ...
 * </p>
 * <p>
 * <code>Job</code> s are to be created by the 'client program', by defining a class that implements the <code>{@link org.quartz.Job}</code>
