...
/**
 * <code>CalendarIntervalScheduleBuilder</code> is a {@link ScheduleBuilder} that defines calendar time (day, week, month, year) interval-based schedules for <code>Trigger</code>s.
 * <p>
