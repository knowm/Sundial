...
public interface TimeBroker {
  ...
  /**
   * <p>
   * Called by the QuartzScheduler before the <code>TimeBroker</code> is used, in order to give the it a chance to initialize.
   * </p>
   */
  ...
  /**
   * <p>
   * Called by the QuartzScheduler to inform the <code>TimeBroker</code> that it should free up all of it's resources because the scheduler is shutting down.
   * </p>
   */
  void shutdown();
