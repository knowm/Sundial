...
/**
 * A JobFactory that instantiates the Job instance (using the default no-arg constructor, or more specifically: <code>class.newInstance()</code>), and then attempts to set all values in the <code>JobExecutionContext</code>'s <code>JobDataMap</code>
 * onto bean properties of the <code>Job</code>.
 * 
