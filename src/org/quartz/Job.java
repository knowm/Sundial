...
public interface Job {
   ...
   * </p>
   * <p>
   * The implementation may wish to set a {@link JobExecutionContext#setResult(Object) result} object on the {@link JobExecutionContext} before this method exits. The result itself is meaningless to Quartz, but may be informative to
   * <code>{@link JobListener}s</code> or <code>{@link TriggerListener}s</code> that are watching the job's execution.
   * </p>
   * 
