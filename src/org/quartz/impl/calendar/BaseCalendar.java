 ...
 * </p>
 * <p>
 * Regarded as base functionality is the treatment of base calendars. Base calendar allow you to chain (stack) as much calendars as you may need. For example to exclude weekends you may use WeeklyCalendar. In order to exclude holidays as well you may
 * define a WeeklyCalendar instance to be the base calendar for HolidayCalendar instance.
 * </p>
 * 
...
public class BaseCalendar implements Calendar, Serializable, Cloneable {
   ...
   * 
   * @return This Calendar's timezone, <code>null</code> if Calendar should use the <code>{@link TimeZone#getDefault()}</code>
   */
  ...
  /**
   * Build a <code>{@link java.util.Calendar}</code> for the given timeStamp. The new Calendar will use the <code>BaseCalendar</code> time zone if it is not <code>null</code>.
   */
  ...
  /**
   * Returns the end of the given day <code>{@link java.util.Calendar}</code>. This calculation will take the <code>BaseCalendar</code> time zone into account if it is not <code>null</code>.
   * 
