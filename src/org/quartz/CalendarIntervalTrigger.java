...
public interface CalendarIntervalTrigger extends Trigger {
  ...
  /**
   * <p>
   * Instructs the <code>{@link Scheduler}</code> that upon a mis-fire situation, the <code>{@link CalendarIntervalTrigger}</code> wants to have it's next-fire-time updated to the next time in the schedule after the current time (taking into account
   * any associated <code>{@link Calendar}</code>, but it does not want to be fired now.
   * </p>
   */
